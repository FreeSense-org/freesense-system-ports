...
// See FreeSense-Status_Monitoring.priv.inc for the page priv data for status_monitoring.
...
<form class=" collapse <?=$panel_state?> auto-submit" method="post" action="/status_monitoring.php" id="monitoring-settings-form">
	<div class="card mb-3" id="monitoring-settings-panel">
		<div class="card-header">
			<h2 class="h5 mb-0"><?=gettext("Settings"); ?>
				<span class="widget-heading-icon">
					<a data-bs-toggle="collapse" href="#monitoring-settings-panel_panel-body">
						<i class="fa-solid fa-plus-circle"></i>
					</a>
				</span>
			</h2>
		</div>
		<div id="monitoring-settings-panel_panel-body" class="card-body collapse <?=$panel_body_state?>">
			<div class="row mb-3">
			...
			<div class="row mb-3">
				...
				<div class="col-sm-2">
					<select class="form-control" data-bs-toggle="tooltip" data-trigger="hover" data-placement="top" title="You must save this view for the refresh interval to take effect." id="refresh-interval" name="refresh-interval">
			...
			<div class="row mb-3" id="custom-time" style="display:none;">
				<label class="col-sm-2 col-form-label">
	...
	***/
	...
	function calculate_summary(data) {
		...
		data.forEach (function(d, i) {
			...
			if (d.unit_acronym) {
				units = '<acronym data-bs-toggle="tooltip" title="' + d.unit_desc + '">' + d.unit_acronym + '</acronym>';
			}
